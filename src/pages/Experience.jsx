  ...
  return (
    <div className="experience">
      <VerticalTimeline lineColor="#333333">
        <VerticalTimelineElement className="vertical-timeline-element-education" date="2017 - 2021" iconStyle={{background: "#c5f9e6", color: "red" }} icon={<School />}>
        ...
        <VerticalTimelineElement className="vertical-timeline-element-title" date="2024 - ?" iconStyle={{background: "#c5f9e6", color: "red" }} icon={<Work />}>
